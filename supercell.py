...
(c) 2019 Lorenzo Gaifas
I made some changes to the script in order to adapt it to the purpose of Martini trajectories.
Refer to the PymolWiki to see the original script: https://pymolwiki.org/index.php/Supercell
"""
...
def supercell(a=2, b=2, c=1, object=None, color=None, name='supercell', withmates=1):
    """
DESCRIPTION
